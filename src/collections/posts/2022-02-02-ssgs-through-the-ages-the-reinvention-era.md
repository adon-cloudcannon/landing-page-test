...
## **[Hugo](https://gohugo.io/){: target="\_blank" rel="noopener noreferrer"}**

*by [Steve Francia](https://github.com/spf13){: target="\_blank" rel="noopener noreferrer"}*
...
Hugo has seen success with corporate customers, including [1Password](https://support.1password.com/){: target="\_blank" rel="noopener noreferrer"}, [Linode](https://www.linode.com/docs/){: target="\_blank" rel="noopener noreferrer"} [Digital.gov](https://digital.gov/){: target="\_blank" rel="noopener noreferrer"}, [KeyCDN](https://www.keycdn.com/){: target="\_blank" rel="noopener noreferrer"}, and [Let's Encrypt](https://letsencrypt.org/){: target="\_blank" rel="noopener noreferrer"}, to name just a few. [Bj&oslash;rn Erik Pedersen](https://github.com/bep){: target="\_blank" rel="noopener noreferrer"} took over as the lead maintainer in 2015 and continues to lead Hugo's thriving community.
...
## **[Hexo](https://hexo.io/){: target="\_blank" rel="noopener noreferrer"}**
...
> \[translated from Traditional Chinese\] I think every [Octopress](http://octopress.org/){: target="\_blank" rel="noopener noreferrer"} user must have such troubles — as the number of articles increases, the speed of file creation becomes slower and slower. This site has grown to 54 articles, and it takes at least one minute to create a file every time.
...
Hexo wasn't the first JavaScript-based SSG, but it was the first to gain a significant following. It has a similar feature set to Jekyll, a vast number of [themes](https://hexo.io/themes/){: target="\_blank" rel="noopener noreferrer"} and [plugins](https://hexo.io/plugins/){: target="\_blank" rel="noopener noreferrer"}, and has the ability for deep customization for those familiar with Node.js.
...
*by [Brock Whitten](https://github.com/sintaxi){: target="\_blank" rel="noopener noreferrer"}*
...
## **[Metalsmith](https://metalsmith.io/){: target="\_blank" rel="noopener noreferrer"}**

*by [Ian Storm Taylor](https://github.com/ianstormtaylor)*

In 2011, Ian Storm Taylor cofounded [Segment](https://segment.com/){: target="\_blank" rel="noopener noreferrer"}, a customer data platform that helps collect, clean, and control customer data. Years later, he created the SSG Metalsmith, which he used to power the Segment technical documentation. Just this week, after a 5-year maintenance mode break, [Kevin Van Lierde](https://github.com/webketje){: target="\_blank" rel="noopener noreferrer"} took over as lead developer and maintainer, and [shared his roadmap](https://www.metalsmith.io/news/2022-01-27/metalsmith-is-back/){: target="\_blank" rel="noopener noreferrer"} for future features and patches.
...
## **[Zola](https://www.getzola.org/){: target="\_blank" rel="noopener noreferrer"}**

*by [Vincent Prouillet](https://github.com/Keats){: target="\_blank" rel="noopener noreferrer"}*

Vincent gets straight to the point in his announcement of 'Gutenberg' (later [renamed](https://github.com/getzola/zola/issues/377){: target="\_blank" rel="noopener noreferrer"} to Zola).
...
Vincent had been working on his own templating engine, [Tera](https://github.com/Keats/tera){: target="\_blank" rel="noopener noreferrer"} in Rust, and thought building a static site generator would be a great way to further his knowledge of the language. Before long, he had created Gutenberg, an opinionated yet flexible way to build "all kinds of sites, from landing pages to knowledge bases, not only blogs." Gutenberg launched with support for CommonMark for content, category and tag support, automatic RSS feeds, and a host of other features that made it a viable alternative to Hugo.

In 2018, WordPress announced its block-based editor, Gutenberg, and began a heavy marketing campaign. Up against the platform that powered most of the web (an SEO matchup he described as "[a plankton vs a tsunami](https://twitter.com/20100Prouillet/status/1032189593322508288){: target="\_blank" rel="noopener noreferrer"}"), Vincent changed the name to Zola, after the famous French writer.
