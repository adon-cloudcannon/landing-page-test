...
{% bookshop "markdown/image" src:"https://cc-dam.imgix.net/blog/uploads/colour-palette-named.png" alt:"The new CloudCannon colour palette" extend:false border:false %}
...
{% bookshop "markdown/image" src:"https://cc-dam.imgix.net/blog/uploads/image-selector-c.png" alt:"The new image sector UX and UI in CloudCannon" extend:false border:false %}
...
{% bookshop "markdown/image" src:"https://cc-dam.imgix.net/blog/uploads/button-gif.gif" alt:"A gif showing the new button UI in CloudCannon" extend:false border:false %}
...
{% bookshop "markdown/image" src:"https://cc-dam.imgix.net/blog/uploads/context-menu-c.png" alt:"A snippet of the new UI in our file browser and a context menu" extend:false border:false %}
...
{% bookshop "markdown/image" src:"https://cc-dam.imgix.net/blog/uploads/popout-panel-c.png" alt:"A teaser of our upcoming addition to the Visual editor - a popout panel" extend:false border:false %}
