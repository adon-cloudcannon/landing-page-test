...
{% bookshop "markdown/vimeo" video:"https://player.vimeo.com/video/675667608" autoplay:true extend:true border: true %}
...
![Screenshot of Forestry remote admin interface](/uploads/forestry-to-cloudcannon-1.png)
...
![Screenshot of CloudCannon's client sharing feature](https://dam-cdn.cloudcannon.com/client-sharing-example.png)
...
![Screenshot of CloudCannon interface showing how you add a new site](https://dam-cdn.cloudcannon.com/cloudcannon-add-new-site.png)

Create a name for your site.

![Screenshot of CloudCannon interface where you can name your site](https://dam-cdn.cloudcannon.com/cloudcannon-name-your-site.png)
...
![CloudCannon screenshot of the sync files interface](https://dam-cdn.cloudcannon.com/cloudcannon-sync-files.png)
...
![Screenshot of CloudCannon interface where you can select your repository](https://dam-cdn.cloudcannon.com/cloudcannon-repository.png)
...
![Screenshot of CloudCannon interface](https://dam-cdn.cloudcannon.com/cloudcannon-build-site.png)
...
![Screenshot of CloudCannon interface](https://dam-cdn.cloudcannon.com/cloudcannon-site-is-ready.png)
...
* [Structures](https://cloudcannon.com/documentation/articles/defining-what-adds-to-an-array-with-array-structures/#structures) — Define your own components, each with their own content model. Content editors use these components to build, rearrange, and reorganize even the
most complex pages. Conveniently, each Forestry "Field" has a corresponding input on
CloudCannon:

| Forestry.io | CloudCannon |
| --- | --- |
| Text | [Text](https://cloudcannon.com/documentation/articles/using-text-inputs-to-edit-your-data/#text) |
| Textarea | [Textarea](https://cloudcannon.com/documentation/articles/using-text-inputs-to-edit-your-data/#textarea) |
| Number | [Number](https://cloudcannon.com/documentation/articles/using-number-inputs-to-edit-your-data/#number) |
| Toggle | [Switch](https://cloudcannon.com/documentation/articles/using-checkbox-inputs-to-edit-your-data/#switch) |
| Select | [Select](https://cloudcannon.com/documentation/articles/using-select-inputs-to-edit-your-data/#select) |
| Datetime | [Datetime](https://cloudcannon.com/documentation/articles/using-date-and-time-inputs-to-edit-your-data/#datetime) |
| Color Picker | [Color](https://cloudcannon.com/documentation/articles/using-color-inputs-to-edit-your-data/) |
| Tags Field | [Multiselect](https://cloudcannon.com/documentation/articles/using-select-inputs-to-edit-your-data/#multiselect) |
| Sortable List Field | [Array](https://cloudcannon.com/documentation/articles/using-arrays-to-edit-your-data/#array) |
| File Upload | [File](https://cloudcannon.com/documentation/articles/using-upload-inputs-to-edit-your-data/#file) |
| Multi-File Upload | [Array](https://cloudcannon.com/documentation/articles/using-arrays-to-edit-your-data/#array) + [File](https://cloudcannon.com/documentation/articles/using-upload-inputs-to-edit-your-data/#file) |
| Field Group | [Object](https://cloudcannon.com/documentation/articles/editing-objects-in-your-data/#object) |
| Repeatable Field Group | [Complex Array](https://cloudcannon.com/documentation/articles/using-arrays-to-edit-your-data/#complex-and-nested-values) |
| Blocks | [Structures](https://cloudcannon.com/documentation/articles/defining-what-adds-to-an-array-with-array-structures/#structures) |

Furthermore, we’ve created an open-source framework called
[Bookshop](https://github.com/CloudCannon/bookshop) to speed up development and reduce maintenance
...
![Screenshot of CloudCannon interface](https://dam-cdn.cloudcannon.com/cloudcannon-invite-team.png)
...
![Screenshot of CloudCannon interface](https://dam-cdn.cloudcannon.com/cloudcannon-custom-domain.png)
