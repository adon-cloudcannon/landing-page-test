---
_schema: default
title: 'Partner Site of the Month: Blüthner Piano Centre, by Winteractive'
breadcrumb_title:
description: >-
...
Andrew’s customized site and build for Blüthner includes a range of static pages representing products — the Grand Piano range, the upright range, and so on — as well as groups of pages that are set up as <a target="_blank" rel="noopener" href="https://cloudcannon.com/documentation/articles/defining-your-collections/">Collections</a>; select data from these pages are displayed on Blüthner’s product listings page as well as on the individual product page itself.
