...
content_blocks:
  ...
  - _bookshop_name: text
    content_markdown: >-
      ...
      [Live Editing
      API](https://cloudcannon.com/documentation/articles/using-live-editing-with-vanilla-js/){:
      target="_blank" rel="noopener"}. This new feature, specific to our Visual
      ...
      even offer
      [React](https://cloudcannon.com/documentation/articles/using-live-editing-with-react/){:
      target="_blank" rel="noopener"} and
      [Svelte](https://cloudcannon.com/documentation/articles/live-editing-with-svelte/){:
      target="_blank" rel="noopener"} connectors to wire it up out-of-the-box.
      ...
      Bindings](https://cloudcannon.com/documentation/articles/what-are-visual-data-bindings/){:
      target="_blank" rel="noopener"}. These bindings tell CloudCannon to
      ...
      target="_blank" rel="noopener"}. To build a meaningful page out of data,
  ...
  - _bookshop_name: spacing
    ...
    tablet_unit_number: 4
    laptop_unit_number: 5
  ...
  - _bookshop_name: text
    content_markdown: >-
      ...
      front-matter named `content_blocks`.”<br>In CloudCannon, the editor would
      see the following:


      ![Modal in CloudCannnon showing two component examples, with the Hero
      component
      highlighted.](https://dam-cdn.cloudcannon.com/Component-modal.png
      "CloudCannon component block")
  ...
  - _bookshop_name: text
    content_markdown: >-
      ...
      update the page correctly. See how the [starter
      template](https://github.com/CloudCannon/hugo-bookshop-starter/blob/main/component-library/shared/hugo/page.hugo.html){:
      target="_blank" rel="noopener noreferrer"} implements this for an example.
      ...
      target="_blank" rel="noopener noreferrer"}&nbsp;while setting this up on a
      ...
      Guide](https://github.com/CloudCannon/bookshop/blob/main/guides/hugo.adoc){:
      target="_blank" rel="noopener noreferrer"} and check out the [Bookshop
      Hugo Starter](https://github.com/CloudCannon/hugo-bookshop-starter){:
      target="_blank" rel="noopener noreferrer"} template. These resources
      ...
      the [Bookshop issues](https://github.com/CloudCannon/bookshop/issues){:
      target="_blank" rel="noopener noreferrer"} on GitHub or get in touch with
      our support team in-app.
    col:
---
[Bookshop](https://github.com/CloudCannon/bookshop){: target="_blank" rel="noopener noreferrer"}&nbsp;— our open-source page-building toolkit — now supports Hugo, as well as Jekyll and Eleventy.
