...
Building with SvelteKit starter themes can also be a great way for beginners to learn how SvelteKit works. Themes often include fantastic documentation and examples to help newbies learn how to use different configurations and features. But if you’re just getting set up in SvelteKit for the first time, we have a helpful [beginners tutorial here](https://cloudcannon.com/community/learn/sveltekit-beginner-tutorial/) which covers the basics.
...
![Urban SvelteKit template](https://cc-dam.imgix.net/blog/dry-duck.cloudvent.net_.png "Urban")
...
[![Deploy to CloudCannon](https://buttons.cloudcannon.com/deploy.svg)](https://app.cloudcannon.com/register#sites/connect/github/vercel/sveltekit-commerce)
