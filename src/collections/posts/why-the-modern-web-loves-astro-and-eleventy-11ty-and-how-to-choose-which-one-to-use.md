...
{% bookshop 'markdown/anchor' name: "what-is-astro" %}## What is Astro?
...
{% bookshop 'markdown/anchor' name: "what-is-eleventy" %}## What is Eleventy?
...
{% bookshop 'markdown/anchor' name: "astro-eleventy-similarities" %}## Similarities between Astro and Eleventy
...
{% bookshop 'markdown/anchor' name: "astro-eleventy-differences" %}## Differences between Astro and Eleventy
...
{% bookshop 'markdown/anchor' name: "astro-eleventy-comparison" %}## Astro vs. 11ty (Eleventy) comparison at a glance
...
{% bookshop 'markdown/anchor' name: "astro-eleventy-usage" %}## Astro vs. 11ty (Eleventy) usage trends
...
{% bookshop 'markdown/anchor' name: "which-should-i-choose" %}## Which should I choose?
