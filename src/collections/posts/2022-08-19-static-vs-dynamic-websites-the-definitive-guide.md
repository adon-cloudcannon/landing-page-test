...
description: >-
  ...
  you choose? 
series:
image: https://dam-cdn.cloudcannon.com/blog/blog-static-dynamic-definitive-r.jpg
...
![](https://dam-cdn.cloudcannon.com/static-request-vs-dynamic-request.svg)
...
![](https://dam-cdn.cloudcannon.com/speedometer-neptune.svg){: width="100"}
...
Why is speed so important? Well, according to [recent research on user behavior](https://www.portent.com/blog/analytics/research-site-speed-hurting-everyones-revenue.htm){: target="_blank" rel="noopener noreferrer"}, **a site that loads in 1 second has a lead generation conversion rate that’s 3x higher than a site that loads in 5 seconds**. For transaction conversions, that difference slips to 2.5x higher, but the pattern is clear — the more time users spend waiting, the less they’ll spend on the site. And the scariest stat for ecommerce? **If users have to wait up to 4 seconds for a site to load, that site is likely to lose about 80% of their potential conversions**.
...
(Incidentally, the response times for sites hosted through CloudCannon are [among the fastest in the world](https://cloudcannon.com/community/jamstack-hosting-comparison/){: target="_blank" rel="noopener"}. You’re welcome.)

![](https://dam-cdn.cloudcannon.com/chart-line-stacked-neptune.svg){: width="100"}
...
![](https://dam-cdn.cloudcannon.com/creation-neptune.svg){: width="100"}
...
![](https://dam-cdn.cloudcannon.com/static-security-vs-dynamic-security.svg)
...
![](https://dam-cdn.cloudcannon.com/wrench-clock-neptune.svg){: width="100"}
...
![](https://dam-cdn.cloudcannon.com/briefcase-arrow-left-right-neptune.svg){: width="100"}
...
Static sites work incredibly well for [large corporate sites](https://www.papercut.com/){: target="_blank" rel="noopener noreferrer"} that tie together multiple services and products. Because they’re fast, and deliver the same content to all users, they work for [blogs](https://blog.twitch.tv/){: target="_blank" rel="noreferrer noopener"} and [documentation sites](https://www.kubeflow.org/){: target="_blank" rel="noopener noreferrer"}, where immediacy is key to both launching on deadline and reaching users.
