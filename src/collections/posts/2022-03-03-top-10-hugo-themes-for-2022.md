...
* Products can be listed with multiple properties (e.g. colors and sizes" alt:"" extend:false border:false %}
...
{% bookshop "markdown/image" src:"https://cc-dam.imgix.net/_screenshot.png" alt:"" extend:false border:false %}
