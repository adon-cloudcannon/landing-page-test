...
content_blocks:
  ...
  - _bookshop_name: sections/container
    content:
      ...
      blocks:
        - _bookshop_name: simple/heading
          content:
            text: Advance your Jekyll content workflow
          styles:
            element: h2
            width: normal
            desktop:
        ...
        - _bookshop_name: simple/text-block
          content:
            text_markdown: >-
              CloudCannon's Jekyll CMS takes your web development workflow to
              the next level.
          styles:
            width: medium
            desktop:
  ...
  - _bookshop_name: sections/container
    content:
      label: An open source ecosystem
      blocks:
    ...
    content:
      ...
      blocks:
        ...
        - _bookshop_name: simple/text-block
          content:
            text_markdown: >-
              Take your editing team to the next level with the CloudCannon CMS
              for Jekyll's intuitive content editing and powerful publishing
              workflows.
          styles:
            desktop:
              text_alignment:
  ...
  - _bookshop_name: sections/container
    content:
      ...
      blocks:
        - _bookshop_name: simple/heading
          content:
            text: Get started with CloudCannon's Jekyll learning resources
          styles:
            element: h2
            width: tight
            desktop:
        ...
        - _bookshop_name: simple/text-block
          content:
            text_markdown: >-
              Want to learn more about Jekyll? Whether it's Jekyll specific
              documentation, Jekyll tutorials, or Jekyll themes that you're
                ...
                - _bookshop_name: simple/text-block
                  content:
                    text_markdown: >-
                      ...
                      generator written in Ruby. Jekyll is one of the most
                      popular SSGs available. Jekyll renders markdown, or any
                      text written in your favorite markup language to create
                      static sites using layouts. With excellent documentation
                      and an active (and responsive) community, so you’ll be
                      able to find plenty of examples of Jekyll websites for
                      almost any use case.
  ...
  - _bookshop_name: sections/container
    content:
      ...
      blocks:
        - _bookshop_name: simple/heading
          content:
            text: A CMS for Jekyll you can trust
          styles:
            element: h2
            width: normal
            desktop:
        ...
        - _bookshop_name: simple/text-block
          content:
            text_markdown: >-
              ...
              Jekyll can help you and your team.&nbsp;
          styles:
            width: medium
            desktop:
              text_alignment:
